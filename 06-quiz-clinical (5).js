...
async function epStart() {
 ...
 var sys = 'You are a medical exam question generator for ' + epExam + ' exam. IMPORTANT: Generate EXACTLY ' + epQCount + ' MCQ questions - return exactly ' + epQCount + ' items in the JSON array. Return ONLY a raw JSON array. Format: [{"q":"question stem","opts":["A. option","B. option","C. option","D. option"],"ans":"A","exp":"explanation why A is correct","why_wrong":"B is wrong because... C is wrong because... D is wrong because...","subj":"subject","diff":"' + epDiff + '"}]. Subject: ' + epSubj + '. Difficulty: ' + epDiff + '. Make questions ' + (epMode==='highyield'?'high-yield exam-style':'exam-realistic') + '. No markdown, no backticks.';
