var QG_SYSTEMS = {
 'Anatomy': ['Head & Neck','Upper Limb','Lower Limb','Thorax','Abdomen & Pelvis','Neuroanatomy','Back & Vertebral Column','Embryology'],
 'Physiology': ['Cardiovascular','Respiratory','Renal & Fluid','Neurophysiology','Endocrine','GI Physiology','Blood & Haematology','Muscle & Nerve','Reproductive'],
 'Biochemistry': ['Carbohydrate Metabolism','Lipid Metabolism','Protein & Amino Acids','Enzymes','Molecular Biology & Genetics','Vitamins & Minerals','Acid-Base Balance','Nutrition'],
 'Pharmacology': ['Autonomic Drugs','Cardiovascular Drugs','CNS Drugs','Antibiotics & Antimicrobials','Endocrine Drugs','GI Drugs','Respiratory Drugs','Analgesics & NSAIDs','Chemotherapy','Renal Drugs'],
 'Pathology': ['Cell Injury & Death','Inflammation','Neoplasia','Cardiovascular Pathology','Respiratory Pathology','GI Pathology','Renal Pathology','Neuropathology','Haematopathology','Endocrine Pathology'],
 'Microbiology': ['Bacteriology','Virology','Mycology','Parasitology','Immunology','Sterilisation & Disinfection','Hospital Infections'],
 'Medicine': ['Cardiology','Respiratory','Gastroenterology','Hepatology','Nephrology','Neurology','Endocrinology','Haematology','Rheumatology','Dermatology','Infectious Disease','Oncology','Geriatrics','Emergency Medicine'],
 'Surgery': ['General Surgery','Orthopaedics','Neurosurgery','Cardiothoracic Surgery','Vascular Surgery','Urology','Plastic Surgery','Paediatric Surgery','Surgical Oncology','Trauma'],
 'Paediatrics': ['Neonatology','Growth & Development','Nutrition & Malnutrition','Respiratory','Cardiovascular','GI & Hepatology','Neurology','Haematology','Infectious Disease','Endocrine','Renal','Immunology & Allergy','Developmental Disorders'],
 'Obstetrics': ['Normal Pregnancy','Antenatal Care','Labour & Delivery','Postnatal Care','Antepartum Haemorrhage','Postpartum Haemorrhage','Hypertensive Disorders','Medical Disorders in Pregnancy','Obstetric Emergencies','Fetal Medicine'],
 'Gynaecology': ['Gynaecological History & Examination','Embryology & Anatomy','Menstrual Disorders','Contraception','Subfertility','Early Pregnancy Disorders','Endometriosis','Uterine Tumours','Ovarian Tumours','Cervical Tumours','Vulva & Vagina','Urogynecology','Pelvic Organ Prolapse','Menopause'],
 'ENT': ['Ear Anatomy & Physiology','Otitis Media','Otitis Externa','Hearing Loss & Deafness','Vertigo & Balance Disorders','Nasal Anatomy & Physiology','Sinusitis','Epistaxis','Nasal Polyps','Throat & Tonsils','Larynx & Voice Disorders','Head & Neck Tumours','Stridor & Airway'],
 'Ophthalmology': ['Ocular Anatomy & Physiology','Red Eye','Conjunctivitis','Corneal Disorders','Glaucoma','Cataract','Retinal Disorders','Diabetic Eye Disease','Squint & Amblyopia','Eyelid Disorders','Optic Nerve Disorders','Ocular Trauma','Uveitis'],
 'Psychiatry': ['Mental State Examination','Schizophrenia','Bipolar Disorder','Depression','Anxiety Disorders','OCD','PTSD','Eating Disorders','Personality Disorders','Substance Abuse','Child Psychiatry','Dementia & Delirium','Psychopharmacology'],
 'Forensic Medicine': ['Cause of Death','Trauma & Wounds','Asphyxia','Sexual Offences','Toxicology','Medical Jurisprudence','Identification'],
 'Community Medicine': ['Epidemiology','Biostatistics','Disease Prevention','Nutrition & Public Health','Environmental Health','Maternal & Child Health','Health Management','Communicable Diseases','Non-Communicable Diseases'],
 'Mixed': []
};
...
var QG_SYSTEMS = {
 'Anatomy': ['Head & Neck','Upper Limb','Lower Limb','Thorax','Abdomen & Pelvis','Neuroanatomy','Back & Spine'],
 'Physiology': ['Cardiovascular','Respiratory','Renal','Endocrine','Neurophysiology','GI Physiology','Reproductive','Musculoskeletal'],
 'Biochemistry': ['Carbohydrate Metabolism','Lipid Metabolism','Protein & Amino Acids','Enzymes','Molecular Biology','Genetics','Vitamins & Nutrition','Acid-Base Balance'],
 'Pharmacology': ['Autonomic Drugs','Cardiovascular Drugs','CNS Drugs','Antibiotics & Antimicrobials','Endocrine Drugs','GI Drugs','Respiratory Drugs','Analgesics & NSAIDs','Chemotherapy'],
 'Pathology': ['Cell Injury & Inflammation','Neoplasia','Cardiovascular Pathology','Respiratory Pathology','GI Pathology','Renal Pathology','Neuropathology','Haematopathology','Immunopathology'],
 'Microbiology': ['Bacteriology','Virology','Mycology','Parasitology','Immunology','Sterilisation & Disinfection'],
 'Medicine': ['Cardiology','Respiratory','Gastroenterology','Nephrology','Neurology','Endocrinology','Haematology','Rheumatology','Dermatology','Infectious Disease','Musculoskeletal','Oncology'],
 'Surgery': ['General Surgery Principles','GI Surgery','Hepatobiliary','Breast Surgery','Vascular Surgery','Urology','Orthopaedics','Neurosurgery','Burns & Trauma','Surgical Oncology'],
 'Paediatrics': ['Neonatology','Paediatric Cardiology','Paediatric Respiratory','Paediatric GI','Paediatric Neurology','Paediatric Infectious Disease','Growth & Development','Paediatric Haematology','Immunisation','Paediatric Endocrine','Paediatric Renal'],
 'Psychiatry': ['Mood Disorders','Schizophrenia & Psychosis','Anxiety & OCD','Substance Use Disorders','Personality Disorders','Child Psychiatry','Organic Disorders','Psychopharmacology'],
 'Gynaecology': ['Menstrual Disorders','Heavy Menstrual Bleeding','Infertility','Polycystic Ovary Syndrome','Uterine Fibroids','Cervical Cancer','Uterine Cancer','Ovarian Cancer','Vaginal & Vulval Disorders','Pelvic Inflammatory Disease','Endometriosis','Contraception'],
 'Obstetrics': ['Normal Pregnancy & Antenatal Care','Labour & Delivery','Postnatal Care','Preeclampsia & Hypertension','Obstetric Haemorrhage','Gestational Diabetes','Ectopic Pregnancy','Miscarriage & Recurrent Loss','Puerperal Disorders','Perinatal Psychiatric Problems','Multiple Pregnancy','Obstetric Emergencies'],
 'ENT': ['Ear Disorders','Nose & Sinuses','Throat & Larynx','Head & Neck Tumours','Hearing Loss & Tinnitus','Vertigo & Balance'],
 'Ophthalmology': ['Glaucoma','Cataract','Uveitis & Inflammation','Retinal Disorders','Corneal Disorders','Ocular Injuries & Emergencies','Strabismus & Amblyopia','Neuro-ophthalmology','Eyelid & Lacrimal Disorders'],
 'Community Medicine': ['Epidemiology','Biostatistics','Health Education','Environmental Health','Nutrition & Health','Healthcare Systems','Disease Prevention','Occupational Health'],
 'Forensic Medicine': ['Thanatology','Forensic Injuries','Toxicology','Medical Jurisprudence','Sexual Offences'],
 'Clinical Medicine': ['Cardiology','Respiratory','Gastroenterology','Nephrology','Neurology','Endocrinology','Haematology','Rheumatology','Dermatology','Infectious Disease']
};
